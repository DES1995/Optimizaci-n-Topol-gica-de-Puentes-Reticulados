...
### Avance Semana 8 – Optimización de hiperparámetros (Random vs Bayesian)

**Objetivo:**  
Comparar el rendimiento de dos enfoques de optimización de hiperparámetros —**búsqueda aleatoria** y **búsqueda bayesiana (Optuna)**— sobre un modelo KNN, garantizando equivalencia experimental, control de presupuesto y registro de artefactos.
...
- **Presupuesto experimental:** 30 combinaciones o iteraciones por método  
- **Artefactos guardados:** modelos `.joblib`, resultados `.csv`, figuras `.png`
...
**Interpretación:**  
El modelo logra alta precisión en validación, manteniendo bajo error y rápida ejecución. Sin embargo, la selección de pocos vecinos puede hacerlo más sensible al ruido.

---

#### 3. Búsqueda bayesiana (Optuna)
...
**Interpretación:**  
El proceso bayesiano exploró de manera más eficiente el espacio de hiperparámetros, priorizando combinaciones prometedoras y alcanzando mayor rendimiento promedio en validación cruzada.  
Demuestra mejor equilibrio entre sesgo y varianza, con una configuración más generalizable que el baseline (KNN k=9).

---

#### 4. Comparación de resultados

| Método | Mejor R² (CV) | Validación R² | Configuración óptima | Tiempo (s) |
|--------|----------------|----------------|----------------------|-------------|
| Random Search | 0.8636 | 0.9410 | k=3, weights='uniform', p=1 | 2.95 |
| Optuna (Bayes) | 0.9676 | — | k=4, weights='distance', p=2 | 2.70 |

**Conclusión comparativa:**  
- Ambos enfoques convergen rápidamente con bajo costo computacional.  
- **Optuna (Bayes)** logra un mejor desempeño general, optimizando con menor número de ensayos.  
- El modelo resultante es más estable, menos sobreajustado y conserva eficiencia temporal.  

---

#### 5. Resultados adicionales

- **Tabla top-k y evolución:** se generaron las 10 mejores configuraciones y la curva de R² por iteración.  
- **Artefactos guardados:**  
  - `/Week_8/results/knn_random_trials.csv`  
  - `/Week_8/models/knn_random_best.joblib`  
  - `/Week_8/models/optuna_study_knn.pkl`  
- **Visualizaciones:**  
...
**Resumen final:**  
La búsqueda bayesiana (Optuna) superó en rendimiento y estabilidad a la búsqueda aleatoria, utilizando el mismo presupuesto experimental.  
Esto valida su eficacia para la selección inteligente de hiperparámetros en modelos de tipo KNN, manteniendo un excelente balance entre exactitud, costo y capacidad de generalización.
